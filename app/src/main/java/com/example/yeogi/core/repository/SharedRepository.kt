...
object SharedRepository {
    ...
    private val dummyAccommodations = listOf(
        // == 서울 ==
        Accommodation(
            id = 1,
            name = "호텔 신라 서울",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.BusinessCenter, "비즈니스"), Facility(
                    Icons.Default.Spa, "스파"), Facility(Icons.Default.RoomService, "룸서비스")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "어번 아일랜드(야외 수영장)는 유료 시설이며, 특정 패키지 이용 시에만 이용 가능합니다.",
            usageInfo = "• 모든 객실은 금연입니다.\n• 반려동물 동반 입실은 불가합니다.\n• 미성년자는 보호자 동반 없이 이용할 수 없습니다.",
            reviews = listOf(Review("김신라", 5.0, "역시 최고의 호텔입니다. 서비스, 룸 컨디션 모두 만족스러웠어요.", "2025.09.01"), Review("이투숙", 4.0, "수영장이 정말 좋았지만, 주말이라 사람이 너무 많았네요.", "2025.08.28"))
        ),
        Accommodation(
            id = 2,
            name = "롯데호텔 서울",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.BusinessCenter, "비즈니스"), Facility(
                    Icons.Default.LocalBar, "바"), Facility(Icons.Default.AcUnit, "에어컨")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "피트니스 센터 및 수영장은 매월 마지막 주 월요일 휴무입니다.",
            usageInfo = "• 객실 내 흡연 시, 20만원의 추가 요금이 부과됩니다.\n• 주차는 투숙 기간 동안 무료로 제공됩니다.",
            reviews = listOf(Review("박롯데", 5.0, "위치가 너무 좋아서 비즈니스 출장객에게 최고입니다. 룸서비스도 훌륭해요.", "2025.09.05"), Review("최서울", 4.0, "오래된 호텔이라 약간의 세월감은 있지만, 관리가 잘 되어있습니다.", "2025.08.25"))
        ),
        Accommodation(
            id = 3,
            name = "파크 하얏트 서울",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Spa, "스파"), Facility(
                    Icons.Default.RoomService, "룸서비스"), Facility(Icons.Default.LocalBar, "바")
            ),
            checkInTime = "15:00", checkOutTime = "12:00",
            notice = "도심 뷰가 아름다운 인피니티 풀이 호텔의 자랑입니다. 수영모 착용은 필수입니다.",
            usageInfo = "• 주차는 발렛 파킹 서비스만 제공되며, 유료입니다.\n• 애완동물 동반 입실은 불가합니다.",
            reviews = listOf(Review("강남스타일", 5.0, "뷰가 정말 최고입니다. 기념일에 방문했는데 잊지 못할 경험이었어요.", "2025.09.03"))
        ),
        Accommodation(
            id = 4,
            name = "포시즌스 호텔 서울",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Spa, "스파"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.LocalBar, "바")
            ),
            checkInTime = "15:00", checkOutTime = "12:00",
            notice = "광화문에 위치하여 접근성이 매우 뛰어납니다. 일부 객실에서는 경복궁 뷰를 감상할 수 있습니다.",
            usageInfo = "• 객실 내 미니바는 유료입니다.\n• 모든 실내 공간은 금연입니다.",
            reviews = listOf(Review("이종로", 5.0, "가족 여행으로 방문했는데 키즈 라운지가 있어서 아이가 정말 좋아했어요.", "2025.08.22"))
        ),
        Accommodation(
            id = 5,
            name = "시그니엘 서울",
            ...
            reviews = listOf(Review("김송파", 5.0, "프로포즈를 위해 예약했는데, 야경이 정말 압도적이었습니다. 최고의 하루였어요.", "2025.09.01"))
        ),
        Accommodation(
            id = 6,
            name = "가평 하늘정원 펜션",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.OutdoorGrill, "바베큐"), Facility(Icons.Default.Kitchen, "주방"), Facility(
                    Icons.Default.Pool, "개별수영장"), Facility(Icons.Default.Deck, "테라스"), Facility(
                    Icons.Default.SmokeFree, "금연객실"), Facility(
                    Icons.Default.AcUnit, "에어컨")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "바베큐 이용 시 2만원의 추가 요금이 발생합니다. (숯, 그릴 제공)",
            usageInfo = "• 늦은 시간 고성방가는 다른 손님들을 위해 자제 부탁드립니다.\n• 애완동물 입실은 불가합니다.",
            reviews = listOf(Review("김가평", 5.0, "사장님도 친절하시고 방도 깨끗해서 잘 쉬다 갑니다!", "2025.08.15"), Review("최커플", 5.0, "개별 수영장이 있어서 프라이빗하고 너무 좋았어요. 또 오고 싶어요.", "2025.08.11"))
        ),
        // == 부산 ==
        Accommodation(
            id = 11,
        ...
        Accommodation(
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "인피니티풀"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Spa, "스파"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.RoomService, "룸서비스")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "해운대 해변이 내려다보이는 인피니티 풀이 유명합니다. 날씨에 따라 운영이 제한될 수 있습니다.",
            usageInfo = "• 투숙객은 사우나(건식, 습식)를 무료로 이용할 수 있습니다.\n• 전 객실 금연입니다.",
            reviews = listOf(Review("박해운대", 5.0, "인피니티 풀 하나만으로도 올 가치가 충분합니다. 뷰가 정말 최고예요.", "2025.08.18"))
        ),
        Accommodation(
            id = 13,
            name = "힐튼 부산",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "인피니티풀"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Book, "서점"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.Water, "워터하우스")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "리조트 내 '이터널 저니' 서점은 투숙객이 아니어도 이용 가능합니다. 워터하우스는 유료 시설입니다.",
            usageInfo = "• 모든 객실에 프라이빗 발코니가 있습니다.\n• 반려동물 동반은 불가합니다.",
            reviews = listOf(Review("김기장", 5.0, "가족 여행으로 완벽한 곳입니다. 아이들이 놀 거리가 많아서 좋았어요.", "2025.09.04"))
        ),
        // == 제주 ==
        Accommodation(
            id = 15,
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "야외수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Spa, "스파"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.Yard, "정원")
            ),
            checkInTime = "14:00", checkOutTime = "11:00",
            notice = "성인풀과 패밀리풀이 분리되어 있어 쾌적한 이용이 가능합니다. G.A.O. 프로그램을 통해 다양한 체험을 즐겨보세요.",
            usageInfo = "• 공항 셔틀버스를 운행합니다. (사전 예약 필수)\n• 모든 객실은 금연입니다.",
            reviews = listOf(Review("박서귀포", 5.0, "오래되었지만 관리가 정말 잘 되어있고, 직원들의 서비스가 최고 수준입니다. 정원이 아름다워요.", "2025.08.30"))
        ),
        Accommodation(
            id = 16,
            name = "롯데호텔 제주",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "야외수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Casino, "카지노"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.Yard, "정원")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "야외 수영장 '해온'은 사계절 온수풀로 운영됩니다. 화산 분수쇼는 저녁 8시 30분에 시작됩니다.",
            usageInfo = "• 헬로키티 캐릭터 룸이 있어 아이들에게 인기가 많습니다.\n• 반려동물 동반은 불가합니다.",
            reviews = listOf(Review("최중문", 5.0, "아이들과 함께 가기 최고의 호텔입니다. 수영장에서 하루 종일 놀았어요.", "2025.08.25"))
        ),
        Accommodation(
            id = 17,
            name = "제주 돌담집",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Kitchen, "주방"), Facility(Icons.Default.OutdoorGrill, "바베큐"), Facility(
                    Icons.Default.Bathtub, "욕조"), Facility(Icons.Default.SmokeFree, "금연객실"), Facility(
                    Icons.Default.Yard, "정원"), Facility(Icons.Default.AcUnit, "에어컨")
            ),
        ...
        Accommodation(
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "인피니티풀"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Spa, "스파"), Facility(
                    Icons.Default.RoomService, "룸서비스"), Facility(Icons.Default.AcUnit, "에어컨")
            ),
            checkInTime = "15:00", checkOutTime = "12:00",
            notice = "경포 해변에 위치하여 멋진 오션 뷰를 자랑합니다. 인피니티 풀 '비치 온 더 클라우드'가 유명합니다.",
            usageInfo = "• 투숙객은 사우나를 무료로 이용할 수 있습니다.\n• 전 객실 금연입니다.",
            reviews = listOf(Review("김강릉", 5.0, "국내 최고의 호텔 중 하나라고 생각합니다. 뷰, 시설, 서비스 모두 완벽했어요.", "2025.09.08"))
        ),
        Accommodation(
            id = 21,
            name = "스카이베이 호텔 경포",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "인피니티풀"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Store, "편의점"), Facility(
                    Icons.Default.AcUnit, "에어컨"), Facility(Icons.Default.RoomService, "룸서비스")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
        ...
        Accommodation(
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Book, "라이브러리"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.Yard, "정원"), Facility(
                    Icons.Default.AcUnit, "에어컨"), Facility(Icons.Default.Luggage, "짐보관")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "설악산 국립공원 입구에 위치하여 등산객에게 최적의 숙소입니다. 영국 테마의 인테리어가 특징입니다.",
            usageInfo = "• 객실에서 설악산의 아름다운 풍경을 감상할 수 있습니다.\n• 반려동물 동반 입실은 불가합니다.",
            reviews = listOf(Review("박설악", 5.0, "설악산 등반하고 묵었는데 위치가 정말 최고였습니다. 고풍스러운 분위기도 좋았어요.", "2025.09.07"))
        ),
        // == 경주 ==
        Accommodation(
            id = 23,
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "야외수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.Book, "북카페"), Facility(
                    Icons.Default.FamilyRestroom, "키즈 라운지"), Facility(Icons.Default.Store, "편의점")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
            notice = "보문호수 바로 앞에 위치하고 있습니다. 리모델링하여 시설이 매우 깨끗하고 현대적입니다.",
            usageInfo = "• 투숙객은 수영장을 무료로 이용할 수 있습니다.\n• 전 객실 금연입니다.",
            reviews = listOf(Review("김경주", 5.0, "리모델링해서 정말 좋아졌네요. 아이들과 함께 호캉스하기 최고의 장소입니다.", "2025.08.29"))
        ),
        Accommodation(
            id = 24,
            name = "황리단길 한옥 스테이",
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.FreeBreakfast, "조식제공"), Facility(
                    Icons.Default.Kitchen, "공용주방"), Facility(Icons.Default.Luggage, "짐보관"), Facility(
                    Icons.Default.SmokeFree, "금연객실"), Facility(Icons.Default.AcUnit, "에어컨"), Facility(
                    Icons.Default.Yard, "마당"), Facility(Icons.Default.LocalLaundryService, "세탁기")
            ),
            checkInTime = "16:00", checkOutTime = "11:00",
        ...
        Accommodation(
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.HotTub, "사우나"), Facility(
                    Icons.Default.Store, "편의점"), Facility(Icons.Default.AcUnit, "에어컨")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
        ...
        Accommodation(
            ...
            facilities = listOf(
                Facility(Icons.Default.Wifi, "무료 Wifi"), Facility(Icons.Default.LocalParking, "주차가능"), Facility(
                    Icons.Default.Restaurant, "레스토랑"), Facility(Icons.Default.Pool, "루프탑수영장"), Facility(
                    Icons.Default.FitnessCenter, "피트니스"), Facility(Icons.Default.FamilyRestroom, "키즈카페"), Facility(
                    Icons.Default.Store, "편의점"), Facility(Icons.Default.AcUnit, "에어컨")
            ),
            checkInTime = "15:00", checkOutTime = "11:00",
    ...
    private val dummyDomesticRecentSearch = mutableListOf(
        RecentSearch(
            id = 1,
            keyword = "강릉 호텔",
            guest = 2,
    ...
    private val dummyOverseasRecentSearch = mutableListOf(
        RecentSearch(
            id = 4,
            keyword = "도쿄, 일본",
            guest = 2,
